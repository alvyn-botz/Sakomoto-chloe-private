...
exports.event = (prefix) =>{
	return` ⚠️ Event grup belum di aktifkan, hubungi owner bot untuk mengaktifkan`
}
exports.wait = () => {
	return `\`\`\`[ ! ] Proses kak...\`\`\``
	}
...
exports.tahta = (prefix, command) => {
	return `❎ Example ${prefix + command} vynutzxx|alvyn`
	}
exports.noteks = (prefix, command) => {
	return `❎ Example ${prefix + command} alvyn`
	}
exports.botNotAdm = () => {
...
exports.adminGc = () => {
 return `Karena kamu adalah admin jadi bot gk bakal kick kamu`
 }
 exports.izinDt = () => {
